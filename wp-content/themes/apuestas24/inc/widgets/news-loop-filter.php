...
vc_map( array(
	"name" => __("News Loop Filter V2"),
	"base" => "news-loop-filter-v2",
	"category" => __('Content'),
	"params" => array(
		array(
			"type" => "textfield",
...
add_shortcode('news-loop-filter-v2', 'goapostas_filter_news_v2');
function goapostas_filter_news_v2($atts,$content){
	extract(shortcode_atts(array(
      'title' => '',
   	), $atts));
   	$out = '';
   	$out .= '<div class="guias-filter guias-filter-ap24">';
   		$out .= '<div class="wrap">';
   		...
   		$out .= '</div>';
   	$out .= '</div>';
   	$out .= '<div class="news-list news-list-ap24">';
   		$out .= '<div class="wrap">';
	    $out .= '<div class="loop">';
		   		...
		   		if ($count_sports == 1) {
		   			$out .= '<div class="palpites-list news-tw pl-t-big" style="margin:0 10px;">';
				        ...
				        if( $posts->have_posts() ): while( $posts->have_posts() ) : $posts->the_post();
				            ...
				            $out .= '<div class="four-content col-left-'.$count_s.'">';
				            ...
				            $count_s ++;
				            } elseif ($count_s > 2 && $count_s < 5) {
				            	if ($count_s == 3) {
				            		$out .= '<div class="col-right">';
				        			$out .= '<div class="title-news" style="background:#f9cb08;margin-left:0;margin-right:0;">'.$sport->name.'</div>';
				        		}
				            	$out .= '<div class="four-content col-left-'.$count_s.'">';
				            	$out .= '<div class="content">';
				            		$thumb_id = get_post_thumbnail_id();
